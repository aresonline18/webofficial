    ...
    <div className="static-home-wrapper">
      ...
      <section className="stats-section">
        ...
        <div className="stats-header">
          ...
          <p>
            We at Shadow Pages help everyday people generate cash flow from simple faceless instagram brands called Shadow Pages by leveraging automated A.I. systems that handle almost all the work on autopilot.
          </p>
          <p>
            In order for our students to succeed we provide all our resources, A.I. systems and custom tailoring our coaching for them providing 1/1 guidance & support that way winning and achieving their goals is inevitable.
          </p>
        </div>
