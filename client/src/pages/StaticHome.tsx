    ...
    <div className="static-home-wrapper">
      ...
      <section className="stats-section">
        ...
        <div className="stats-header">
          ...
          <p>
            We at Shadow Pages help everyday people generate cash flow from simple faceless instagram brands called Shadow Pages by leveraging automated A.I. systems.
          </p>
          <p>
            We provide all our resources, A.I. systems and custom tailor our coaching for for you alongside providing 1/1 guidance whenever you'd like at your disposable that way winning and achieving your goals is inevitable.
          </p>
        </div>
