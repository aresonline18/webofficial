...
export default function StaticHome() {
  useEffect(() => {
    // Load Google fonts and external scripts
    const googleFonts = document.createElement('link');
    googleFonts.href = 'https://fonts.googleapis.com/css2?family=Sora:wght@300;500;600&display=swap';
    googleFonts.rel = 'stylesheet';
    document.head.appendChild(googleFonts);

    const interFonts = document.createElement('link');
    interFonts.href = 'https://fonts.googleapis.com/css2?family=Inter:wght@400;600;700&display=swap';
    interFonts.rel = 'stylesheet';
    document.head.appendChild(interFonts);

    // Load CSS files
    const isolationCss = document.createElement('link');
    isolationCss.href = '/assets/styles/static-home-isolation.css';
    isolationCss.rel = 'stylesheet';
    document.head.appendChild(isolationCss);
    ...
    return () => {
      ...
      try {
        ...
        document.head.removeChild(interFonts);
        document.head.removeChild(isolationCss);
    ...
    <div className="static-home-wrapper">
      ...
      <section className="stats-section">
        ...
        <div className="stats-header">
          ...
          <p>
            We at Shadow Pages help everyday people generate cash flow from simple faceless instagram brands called Shadow Pages which are completely faceless meaning you don't need to show your face and can scale very rapidly by starting more pages & automating them with A.I.
          </p>
          <p>
            In order to help our students accomplish massive results, we provide them all the resources they need, our secret A.I. systems alongisde custom tailoring our coaching for them, excelling with 1/1 guidance and support making sure all our students win and achieve their goals.
          </p>
        </div>
      ...
      <section className="team-section">
        <div className="team-container">
          <div className="team-left">
            ...
            <a href="#" onClick={(e) => { e.preventDefault(); handleHomePageApply(); }} className="team-cta">
              Learn more →
            </a>
          </div>
          ...
          <div className="review-card">
            <div className="stars">
              {Array(5).fill(0).map((_, i) => (
                <img key={i} src="/assets/star.svg" alt="Star" loading="lazy" />
              ))}
            </div>
