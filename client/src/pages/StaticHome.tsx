    ...
    <div className="static-home-wrapper">
      ...
      <section className="stats-section">
        ...
        <div className="stats-header">
          ...
          <p>
            We provide all our resources, A.I. systems alongside custom tailoring our coaching for our students excelling with 1/1 guidance and support ensuring all our students win & succeed.
          </p>
        </div>
