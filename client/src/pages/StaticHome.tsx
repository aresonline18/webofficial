    ...
    <div className="static-home-wrapper">
      ...
      <section className="stats-section">
        ...
        <div className="stats-header">
          ...
          <p>
            In order to ensure our students win, we provide all the resources, A.I. systems alongside our custom tailoring our coaching for them while excelling with 1/1 guidance and support like no other company.
          </p>
        </div>
