    ...
    <div className="static-home-wrapper">
      ...
      <section className="stats-section">
        ...
        <div className="stats-header">
          ...
          <p>
            We provide all our resources, A.I. systems and custom tailoring our coaching for you providing 1/1 guidance & support that way winning and achieving your goals is inevitable.
          </p>
        </div>
