        ...
        <div className="bg-white min-h-screen">
          ...
          <div className="fixed bottom-5 right-5 z-50 md:bottom-5 md:right-5 md:left-auto sticky-cta-mobile">
            <button 
              ...
              className="text-white px-6 py-3 rounded-lg font-semibold text-sm transition-opacity duration-200 shadow-lg hover:shadow-xl w-full md:w-auto hover:opacity-90"
              style={{
          ...
          <div className="py-8">
            ...
            <div className="container mx-auto px-4 mb-12">
              ...
              <h2 className="text-xl md:text-3xl text-center mb-8 md:mb-10 max-w-5xl mx-auto leading-relaxed">
                The complete A to Z system on how Shadow Pages work and how <strong>YOU</strong> can take advantage of them & generate cashflow passively...
              </h2>
            ...
            <div className="container mx-auto px-4 mb-12">
              <div className="max-w-3xl mx-auto space-y-6">
                ...
                <p className="text-gray-800">
                  Now a new era has begun, where <strong>faceless social media brands are taking over</strong> — with Shadow Pages you can profit off social media the same way all these influencers do, but without having to show yourself, be an influencer or create any of the content yourself...
                </p>
                ...
                <div className="my-8 md:my-12">
                  <img 
                    ...
                    className="w-full max-w-2xl md:max-w-4xl mx-auto rounded-lg shadow-2xl"
                    style={{ boxShadow: '0 25px 50px -12px rgba(0, 0, 0, 0.25)' }}
                  />
                </div>

                <h3 className="font-black text-xl md:text-2xl text-black mt-12 md:mt-16 mb-6 md:mb-8 md:pt-2">What Exactly Are Shadow Pages?</h3>
                ...
                <div className="my-8 md:my-12">
                  <img 
                    ...
                    className="w-full max-w-4xl md:max-w-6xl mx-auto rounded-lg"
                  />
                </div>

                <p className="text-gray-800">
                  All you have to do is leverage simple A.I. tools to create all the content for you... (we showcase exactly how to our students)
                </p>

                <p className="text-gray-800">
                  This allows you to completely automate your page while keeping 90-95% profit margins since A.I. tools are becoming cheaper, but also more efficient day by day.
                </p>
                ...
                <p className="text-gray-800">
                  This is a huge opportunity to embrace AI and profit from it, especially with it becoming more & more important in today's day and age. This is exactly how I've automated more than 10 of my pages and how I'm able to only spend 5-15min a day on my pages.
                </p>
                ...
                <h3 className="font-black text-xl md:text-2xl text-black mt-12 md:mt-16 mb-6 md:mb-8 md:pt-1">Here Are My Top 5 Proven Monetization Methods:</h3>
                ...
                <h3 className="font-black text-xl md:text-2xl text-black mt-12 md:mt-16 mb-6 md:mb-8 md:pt-1">Here's My Exact A To Z Process:</h3>
                ...
                <h3 className="font-black text-xl md:text-2xl text-black mt-12 md:mt-16 mb-6 md:mb-8 md:pt-2">But who am I? Here's a quick intro about me:</h3>
                ...
                <h4 className="font-black text-lg md:text-3xl text-black mt-10 md:mt-12 mb-6 md:mb-8 md:pt-1">Here's what my students have to say:</h4>
                ...
                <div className="text-center mb-6">
                  <button 
                    className="w-full px-8 py-6 text-white font-semibold rounded-lg hover:opacity-90 transition-opacity flex flex-col items-center justify-center"
                    style={{
                      background: 'linear-gradient(to bottom, #385DC6, #2C4A9E)'
                    }}
                    onClick={() => window.open('https://www.shadowpages.io/apply-1', '_blank')}
                  >
                    <span className="text-2xl md:text-[2rem] font-black mb-2" style={{ fontFamily: 'Inter', fontWeight: 900 }}>Click Here To Apply</span>
                    <span className="text-sm md:text-base font-normal opacity-90">Fill in a 2min quiz to see if this is for you</span>
                  </button>
                </div>
                ...
                <h3 className="font-black text-xl md:text-4xl text-black mt-12 md:mt-16 mb-6 md:mb-8 md:pt-1 md:pb-1">Frequently Asked Questions</h3>
